...
import com.example.dirvingpatner.databinding.ActivityRcUploadBinding

class RcUpload : AppCompatActivity() {

    private lateinit var binding: ActivityRcUploadBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityRcUploadBinding.inflate(layoutInflater)
        ...
        binding.continueBtn.setOnClickListener{
            ...
            sharedPref.putBoolean("isRCComplete", true)
